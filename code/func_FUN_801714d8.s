# metadata: {"startAddress": "0x801714d8", "size": 380, "inst": 95, "name": "FUN_801714d8", "endAddress": "0x80171653"}

#include "def.h"

### Function: undefined FUN_801714d8(void)
.global FUN_801714d8
FUN_801714d8:	# 0x801714d8 - 0x80171653
    ...
    add r8,r5,r6
    lis r5,-0x7fbb
    lwz r29,0x0(r8)	# op 1: DAT_80405d70
    mulli r10,r3,0x90
    lwz r28,0x4(r8)	# op 1: DAT_80405d74
    addi r9,r5,0x6ec4
    lwz r8,0x118(r30)
    li r6,0x0
    and r3,r7,r29
    ...
    or. r3,r5,r3
    mulli r5,r31,0x24
    lwzx r31,r11,r12	# = 80000001, op 1: PTR_DAT_80405d90
    add r3,r9,r5
    bne LAB_8017157c
    or r5,r8,r28
    or r0,r7,r29
