# metadata: {"startAddress": "0x801b5f08", "size": 368, "inst": 92, "name": "FUN_801b5f08", "endAddress": "0x801b6077"}

#include "def.h"

### Function: undefined FUN_801b5f08(void)
.global FUN_801b5f08
FUN_801b5f08:	# 0x801b5f08 - 0x801b6077
    ...
    subi r6,r4,0x7dd4
    lfs f3,-0x58cc(r2)	# = -128.0, op 1: FLOAT_804ee4f4
    addi r7,r1,0x8
    lfs f2,-0x5788(r2)	# = 364.0, op 1: FLOAT_804ee638
    li r8,0x0
    lfs f1,-0x5784(r2)	# = 768.0, op 1: FLOAT_804ee63c
    lfs f0,-0x5780(r2)	# = 116.0, op 1: FLOAT_804ee640
