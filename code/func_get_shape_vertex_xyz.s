# metadata: {"startAddress": "0x8025b700", "size": 908, "inst": 227, "name": "get_shape_vertex_xyz", "endAddress": "0x8025ba8b"}

#include "def.h"

### Function: undefined get_shape_vertex_xyz(void)
.global get_shape_vertex_xyz
get_shape_vertex_xyz:	# 0x8025b700 - 0x8025ba8b
...
LAB_8025b75c:
    ...
    subi r5,r4,0x5d8c	# = "shape_set->vertex_desc->comp_cnt == GX_POS_XYZ", op 0: s_shape_set->vertex_desc->comp_cnt_802fa274
    li r4,0x435
    bl HSD_Assert
LAB_8025b77c:
    lwz r5,0x8(r29)
...
LAB_8025ba5c:
    lis r4,-0x7fd0
    subi r3,r2,0x4cb8	# = "pobj.c", op 0: s_pobj.c_804ef108
    subi r5,r4,0x5d5c	# = "unexpected vertex type.\n", op 0: s_unexpected_vertex_type._802fa2a4
    li r4,0x460
    bl HSD_Halt
LAB_8025ba70:
